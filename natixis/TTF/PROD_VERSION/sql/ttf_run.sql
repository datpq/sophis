BEGIN
    ...
    TTF.COMPTE_PROPRE(to_date('&1', 'YYYYMMDD'));
    TTF.COMPTE_TIERS(to_date('&1', 'YYYYMMDD'));
END;
/
...
SELECT '<h3>TTF - ' || TO_CHAR(TRUNC(to_date('&1', 'YYYYMMDD')), 'MON YYYY') || '</h3>' FROM DUAL;

SELECT '<br><b>Message TTF</b>' FROM DUAL;
