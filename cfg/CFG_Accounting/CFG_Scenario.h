#ifndef __CSxScenario__H__
	#define __CSxScenario__H__
...
*/
class CSxScenario : public sophis::scenario::CSRScenario
{
//------------------------------------ PUBLIC ------------------------------------
public:
    DECLARATION_SCENARIO(CSxScenario);
...
private:
	...
	_STL::string remainingParam;
};

#endif // !__CSxScenario__H__
