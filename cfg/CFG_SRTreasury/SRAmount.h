#ifndef __SRAmount_H__
	#define __SRAmount_H__
...
@see CSRExtraction
*/
class SRAmount : public sophis::portfolio::CSRPortfolioColumn
{
//------------------------------------ PUBLIC ---------------------------------
public:
	static _STL::map<long,double> cache;
	static int refreshVersion;
	...
	//DPH
	//double getAmountValue(long portfolioCode,const CSRExtraction *extraction)const ;
	double getAmountValue(long portfolioCode, PSRExtraction extraction)const;

//------------------------------------ PRIVATE --------------------------------
private:

	DECLARATION_PORTFOLIO_COLUMN(SRAmount)

};

#endif //!__SRAmount_H__