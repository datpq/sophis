...
{
    public class CSxGetPriceFromYtmXMLSource : CSMXMLSource
    {
        [Persistent]
        ...
        public override void GenerateXMLDescription(System.Data.DataSet dataSet, bool inPreviewMode, eMGenerationType generationType)
        {
            ...
            try
            {
                ...
                price = bondPricer.GetPriceFromYTM(InstrumentReference, computationDate, PricingModel, QuotationType, YTM*.01);
