#ifndef __CheckListedBond_H__
	#define __CheckListedBond_H__
...
** Class
*/
class CheckListedBond : public sophis::portfolio::CSRTransactionAction
{
	DECLARATION_TRANSACTION_ACTION(CheckListedBond);
...
public:
	...
	*/
	...
	void BondCheckListedBond(const sophis::portfolio::CSRTransaction * original, const sophis::portfolio::CSRTransaction * transaction, bool isDeleted = false);

	int HandleException(const VoteException & ex, const char* operation) throw (VoteException);
