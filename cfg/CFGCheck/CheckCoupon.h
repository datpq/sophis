#ifndef __CheckCoupon_H__
	#define __CheckCoupon_H__
...
** Class
*/
class CheckCoupon : public sophis::portfolio::CSRTransactionAction
{
	DECLARATION_TRANSACTION_ACTION(CheckCoupon);
...
public:
	...
	*/
	...
	void BondCheckCoupon(const sophis::portfolio::CSRTransaction * original, const sophis::portfolio::CSRTransaction * transaction, bool isDeleted = false);

	bool HasACoupon(long startDate, long endDate, const CSRBond * currentBond);
