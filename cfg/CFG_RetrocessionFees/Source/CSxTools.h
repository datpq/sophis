...
public:
	...
	static _STL::string GetAccountsListQuery(_STL::string accountsListStr);
	static void GetAccountsList(_STL::string accountsListStr, _STL::set<_STL::string>& accountList);
	static void GetIdentList(_STL::string  parameterStr, _STL::vector<long>& identList);	
