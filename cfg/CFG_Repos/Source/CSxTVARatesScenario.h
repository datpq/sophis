#ifndef __CSxTVARatesScenario__H__
	#define __CSxTVARatesScenario__H__
...
*/
class CSxTVARatesScenario : public sophis::scenario::CSRScenario
{
//------------------------------------ PUBLIC ------------------------------------
public:
    DECLARATION_SCENARIO(CSxTVARatesScenario);
...
#endif // !__CSxTVARatesScenario__H__
