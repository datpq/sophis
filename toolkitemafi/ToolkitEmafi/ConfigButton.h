#ifndef __ConfigButton__H__
	#define __ConfigButton__H__
...
*/
class ConfigButton : public sophis::scenario::CSRScenario
{
	//------------------------------------ PUBLIC ------------------------------------
public:
	DECLARATION_SCENARIO(ConfigButton);
