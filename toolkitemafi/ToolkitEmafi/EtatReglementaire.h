#ifndef __EtatReglementaireRibbon_H__
	#define __EtatReglementaireRibbon_H__
...
*/
class EtatReglementaire : public sophis::scenario::CSRScenario
{
	//------------------------------------ PUBLIC ------------------------------------
public:
	DECLARATION_SCENARIO(EtatReglementaire);
...
#endif // !__EtatReglementaireRibbon_H__
