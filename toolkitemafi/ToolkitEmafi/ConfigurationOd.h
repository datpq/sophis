#ifndef __ConfigurationOD__H__
	#define __ConfigurationOD__H__
...
*/
class ConfigurationOD : public sophis::scenario::CSRScenario
{
	//------------------------------------ PUBLIC ------------------------------------
public:
	DECLARATION_SCENARIO(ConfigurationOD);
