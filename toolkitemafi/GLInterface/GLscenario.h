...
#ifndef __GLscenario__H__
	#define __GLscenario__H__
...
*/
class GLscenario : public sophis::scenario::CSRScenario
{
//------------------------------------ PUBLIC ------------------------------------
public:

    DECLARATION_SCENARIO(GLscenario);
