#ifndef __RapprEspeces__H__
	#define __RapprEspeces__H__
...
*/
class RapprEspeces : public sophis::scenario::CSRScenario
{
	//------------------------------------ PUBLIC ------------------------------------
public:
	DECLARATION_SCENARIO(RapprEspeces);
