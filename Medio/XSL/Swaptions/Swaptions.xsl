...
<!-- Counterparty Name (compensation broker) -->
  ...
  <xsl:value-of select="$seperator"/>
<!-- Product Type -->
  <xsl:value-of select="'Swaps Option'"/>
  <xsl:value-of select="$seperator"/>
<!-- Underlying ID -->
...
<xsl:value-of select="$seperator"/>
<!-- Option Type -->
<xsl:value-of select="concat($option_type,' ', $payer_receiver)"/>
<xsl:value-of select="$seperator"/>
<!-- Barrier1 -->
...
<xsl:value-of select="$seperator"/>
<!-- Frequency of underlying floating rate   -->
<xsl:value-of select="$payment_frequency"/>
<xsl:value-of select="$seperator"/>
<!-- Base of the Underlying floating rate    -->
<xsl:value-of select="$base_floating_rate"/>
<xsl:value-of select="$seperator"/>
<!-- Underlying Floating Rate Spread         -->
<xsl:value-of select="$floating_rate_spread"/>
<xsl:value-of select="$seperator"/>
<!-- Maturity of the underlying swap         -->
<xsl:call-template name="termination_date"/>
