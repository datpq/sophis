...
-->
  ...
  <xsl:template name="SEC-COD">
    <xsl:value-of select="//ns0:sph_otc_message/ns0:instrument/ns5:equityFuture/ns5:identifier/ns5:reference[@ns5:name='Bloomberg']"/>
  </xsl:template>
  ...
  <xsl:template name="BuySell">
    ...
    <xsl:variable name="entity" select="/ns0:sph_otc_message/ns0:source/ns1:tradeSource/ns2:trade/ns2:entityPartyReference/ns3:partyId[ns3:partyIdScheme='http://www.sophis.net/party/partyId/id']"/>
  ...
  <xsl:variable name="OPE_TYP_OLD">
    ...
    <xsl:variable name="entity" select="/ns0:sph_otc_message/ns0:source/ns1:tradeSource/ns2:trade/ns2:entityPartyReference/ns3:partyId/ns3:partyId[ns3:partyIdScheme='http://www.sophis.net/party/partyId/id']"/>

    <xsl:choose>
      <xsl:when test="$buyer = $entity">
        <xsl:text>AFP</xsl:text>
      </xsl:when>
      <xsl:otherwise>
  ...
  <xsl:variable name="und_sec_des">
    ...
    <xsl:value-of select="/ns0:sph_otc_message/ns0:instrument/*/ns5:underlyer/ns5:reference[@ns5:name='Bloomberg']"/>
 </xsl:variable>
...
<xsl:template match="*">
  ...
  <xsl:value-of select="$seperator"/>
  <!-- MGP [NEED MORE INFO] fund id  nostro account number -->
  ...
  <xsl:value-of select="$seperator"/>
  <!-- CLR-BRK-DES [TODO][NEED MORE INFO] -->
  <xsl:value-of select="$seperator"/>
  ...
  <xsl:value-of select="$seperator"/>
  <!-- BEN-REF-SAFE [TODO][NEED MORE INFO] -->
  <xsl:value-of select="$seperator"/>
  ...
  <xsl:call-template name="tradeid"/>
  <xsl:value-of select="$seperator"/>
  <!-- DEAL-TYP [TODO][NEED MORE INFO][NOT FOUND]-->
  <xsl:value-of select="'T'"/>
  <xsl:value-of select="$seperator"/>
  <!-- EUR_US_FLG [TODO][NOT FOUND] -->
  <xsl:value-of select="$seperator"/>
  <!-- STR-PRI [TODO][NOT FOUND] related to the...? -->
  <xsl:value-of select="$seperator"/>
  <!-- QUO-PLC [TODO][NEED MORE INFO] not in the xml-->
  <xsl:value-of select="$seperator"/>
  <!-- UND_SEC_COD [TODO][NEED MORE INFO] optional -->
  <xsl:value-of select="$und_sec_cod"/>
  <xsl:value-of select="$seperator"/>
  <!-- UND_SEC_TYPE [TODO][NEED MORE INFO] -->
