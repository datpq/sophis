#ifndef __CSxIsDelegateAutoCondition_H__
	#define __CSxIsDelegateAutoCondition_H__
...
namespace sophis	{
	...
	/**
	Class CSxIsDelegateAutoCondition:
	*/
	class CSxIsDelegateAutoCondition : public sophis::portfolio::CSRAutoTransmitCondition
	{
	//------------------------------------ PUBLIC ---------------------------------
	public:

		DECLARATION_AUTO_TRANSMIT_CONDITION(CSxIsDelegateAutoCondition)
