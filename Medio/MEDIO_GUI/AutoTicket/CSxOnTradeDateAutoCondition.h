#ifndef __CSxOnTradeDateAutoCondition_H__
	#define __CSxOnTradeDateAutoCondition_H__
...
namespace sophis	{
	...
	/**
	Class CSxOnTradeDateAutoCondition:
	*/
	class CSxOnTradeDateAutoCondition : public sophis::portfolio::CSRAutoTransmitCondition
	{
	//------------------------------------ PUBLIC ---------------------------------
	public:

		DECLARATION_AUTO_TRANSMIT_CONDITION(CSxOnTradeDateAutoCondition)
