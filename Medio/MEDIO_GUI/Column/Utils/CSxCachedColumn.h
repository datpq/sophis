...
protected:
	...
	// ------------------------------------PROTECTED(Consolidate Under)-------------------- -
		...
		virtual void SetPositionStyle(SSCellStyle			*cellStyle, long currencyCode)const{ return CSxColumnHelper::SetStyleForDouble(*cellStyle, currencyCode, true, 2, false); };
		virtual void SetPortfolioStyle(SSCellStyle			*cellStyle, long currencyCode)const{ return CSxColumnHelper::SetStyleForDouble(*cellStyle, currencyCode, true, 2, true); };
