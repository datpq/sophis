#ifndef __CSxMarketValueColumn_H__
	#define __CSxMarketValueColumn_H__
...
@see CSRExtraction
*/
class CSxMarketValueColumn : public CSxCachedColumn
{
//------------------------------------ PUBLIC ---------------------------------
public:
...
//------------------------------------ PRIVATE --------------------------------
private:
	DECLARATION_PORTFOLIO_COLUMN(CSxMarketValueColumn)
	static const char* __CLASS__;
};

#endif //!__CSxMarketValueColumn_H__