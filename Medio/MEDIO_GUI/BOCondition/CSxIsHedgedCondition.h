#pragma once
#ifndef __CSxIsHedgedCondition_H__
#define __CSxIsHedgedCondition_H__
...
class CSxIsHedgedCondition : public sophis::backoffice_kernel::CSRKernelCondition
{
	DECLARATION_WORKFLOW_DEF_CONDITION(CSxIsHedgedCondition);
...
#endif //!__CSxIsHedgedCondition_H__
