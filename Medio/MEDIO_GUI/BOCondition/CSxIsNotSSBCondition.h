#ifndef __CSxIsNotSSBCondition_H__
	#define __CSxIsNotSSBCondition_H__
...
class CSxIsNotSSBCondition : public sophis::backoffice_kernel::CSRKernelActionCondition
{
	DECLARATION_KERNEL_ACTION_CONDITION(CSxIsNotSSBCondition);
...
#endif //!__CSxIsNotSSBCondition_H__