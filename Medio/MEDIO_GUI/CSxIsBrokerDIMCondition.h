...
#ifndef __CSxIsBrokerDIMCondition_H__
#define __CSxIsBrokerDIMCondition_H__
...
class CSxIsBrokerDIMCondition : public sophis::backoffice_kernel::CSRKernelActionCondition
{
	DECLARATION_KERNEL_ACTION_CONDITION(CSxIsBrokerDIMCondition);
