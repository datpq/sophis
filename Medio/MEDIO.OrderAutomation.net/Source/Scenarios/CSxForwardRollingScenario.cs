...
namespace MEDIO.OrderAutomation.net.Source.Scenarios
{
	...
	/// </summary>
	public class CSxForwardRollingScenario : sophis.scenario.CSMScenario
	{
        ...
        {
            XSRWinFormsAdapter<CSxFXRollingForm> adapter = XSRWinFormsAdapter<CSxFXRollingForm>.GetUniqueDialog("Medio FX Forward Roll", true);
