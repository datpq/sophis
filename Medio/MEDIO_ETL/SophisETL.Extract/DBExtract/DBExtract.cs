...
using SophisETL.Extract.DBExtract.Xml;



namespace SophisETL.Extract.DBExtract
{
    /// <summary>
    ...
    public class DBExtract : IExtractStep
    {
        ...
        private void StoreRecordInformations( OracleDataReader reader )
        {
