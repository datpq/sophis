#ifndef __CSxCheapestToDeliver_H__
	#define __CSxCheapestToDeliver_H__
...
@see CSRExtraction
*/
class CSxCheapestToDeliver: public sophis::portfolio::CSRPortfolioColumn
{
//------------------------------------ PUBLIC ---------------------------------
public:
...
private:
	...
	DECLARATION_PORTFOLIO_COLUMN(CSxCheapestToDeliver)
	// std::string getTopLevelFolio(long portfolioCode) const;
	// static int previousRefreshVersion_;
};

#endif //!__CSxCheapestToDeliver_H__