#ifndef __CSxCTDSicovam_H__
#define __CSxCTDSicovam_H__
...
@see CSRExtraction
*/
class CSxCTDSicovam : public sophis::portfolio::CSRPortfolioColumn
{
	//------------------------------------ PUBLIC ---------------------------------
public:
...
private:
	...
	DECLARATION_PORTFOLIO_COLUMN(CSxCTDSicovam)
