...
#ifndef __CSxGrossLeverageColumn_H__
#define __CSxGrossLeverageColumn_H__
...
@see CSRExtraction
*/
class CSxGrossLeverageColumn : public CSxCachedColumn//public sophis::portfolio::CSRPortfolioColumn
{
	//------------------------------------ PUBLIC ---------------------------------
public:
	...
	static map<long,string> AllotmentMap;
	//------------------------------------ PRIVATE --------------------------------
private:
	static const char* __CLASS__;
	
	DECLARATION_PORTFOLIO_COLUMN(CSxGrossLeverageColumn)
	
};

#endif //!__CSxGrossLeverageColumn_H__