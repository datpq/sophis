#ifndef __CSxGrossLeverageFundCcy_H__
#define __CSxGrossLeverageFundCcy_H__
...
@see CSRExtraction
*/
class CSxGrossLeverageFundCcy : public CSxCachedColumn//public sophis::portfolio::CSRPortfolioColumn
{
	//------------------------------------ PUBLIC ---------------------------------
public:
...
private:
	...
	DECLARATION_PORTFOLIO_COLUMN(CSxGrossLeverageFundCcy)

};

#endif //!__CSxGrossLeverageFundCcy_H__