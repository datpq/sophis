#ifndef __CSxDOBAssetValueIndicator_H__
	#define __CSxDOBAssetValueIndicator_H__
...
/**
Class CSxDOBAssetValueIndicator:
*/
class CSxDOBAssetValueIndicator : public CSMPIndicator
{
//------------------------------------ PUBLIC ---------------------------------
public:
	...
	DECLARATION_MP_INDICATOR(CSxDOBAssetValueIndicator);
