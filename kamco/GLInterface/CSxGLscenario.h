...
#ifndef __CSxGLscenario__H__
#define __CSxGLscenario__H__
...
class CSxGLscenario : public sophis::scenario::CSRScenario
{
//------------------------------------ PUBLIC ------------------------------------
public:

	DECLARATION_SCENARIO(CSxGLscenario);
