...
{
    public class PC_Coupon : sophis.portfolio.CSMColumnConsolidate
    {
    ...
    public class PC_InvCash : sophis.portfolio.CSMColumnConsolidate
    {
        //Get instance of the DataSource singleton
    ...
    public class PC_ReceivedCoupons : sophis.portfolio.CSMColumnConsolidate
    {
        //Get instance of the DataSource singleton
    ...
    public class PC_ReceivedCouponsLocalCCY : sophis.portfolio.CSMColumnConsolidate
    {
        //Get instance of the DataSource singleton
    ...
    public class PC_TMZAccrued : sophis.portfolio.CSMColumnConsolidate
    {
        //Get instance of the DataSource singleton
    ...
    public class PC_FixedOrFloat : sophis.portfolio.CSMColumnConsolidate
    {
        //Get instance of the DataSource singleton
